...
const page = () => {
  return (
    <div className='w-full h-full'>
      <Title text="About Me" />
      <div className='w-full lg:h-[180vh] md:h-[120vh] h-[250vh]  bg-[#F8FFE5] flex flex-col items-center justify-center'>
        <div className='md:w-[98%] lg:w-[80%] w-[95%]  h-full grid lg:grid-rows-[2fr_0.8fr] md:grid-rows-[2fr_0.6fr] grid-rows-[2fr_0.4fr] gap-4 md:p-2 lg:p-10 mb-10'>
          ...
          <div className=" h-full grid lg:grid-cols-[1fr_1.2fr] md:grid-cols-[1fr_1fr]   gap-4">
            ...
            {/* Left Column */}
            <div className=" h-full grid lg:grid-rows-[1fr_3fr] grid-rows-[1fr_2.5fr] gap-2">
              <div className="">
              ...
              <div className="bg-[#C3E3FF] flex justify-center items-center rounded-4xl drop-shadow-xl shadow-xl">
                <div className=' relative w-[99%] h-[99%] border-2 rounded-4xl flex flex-col items-center justify-center'>
                <div className='absolute top-5 left-10 text-[3rem] text-[#0F3443] font-[600] font-playfair'>
